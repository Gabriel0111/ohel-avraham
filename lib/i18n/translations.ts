...
export const translations = {
  en: {
    ...
    search: {
      ...
      guestPlaceholder: "Search by name, region...",
      noGuests: "No guests found matching your search.",
      searchGuestsBarPlaceholder: "Find a guest for your table...",
      anonymousGuest: "A guest",
      guestsInRegion: "guest",
      guestsInRegionPlural: "guests",
      chooseRegionHint: "Choose a region to see its guests",
      regionPlaceholder: "Filter regions...",
    ...
    requests: {
      ...
      // Host → guest invitation
      inviteDialogTitle: "Invite to your table",
      inviteDialogDesc: "Invite {name} to your Shabbat table.",
      sendInvitation: "Send invitation",
      toastInvitationSent: "Invitation sent.",
      // Thread labels by direction
      wantsToBeHostedLabel: "Would like to be hosted",
    ...
    errors: {
      ...
      guestNotFound: "This guest could not be found.",
    ...
    hostProfile: {
      ...
      unavailablePeriodLabel: "Unavailable period",
      selectPeriod: "Select dates",
      makeUnavailableIndefinitely: "Unavailable until further notice",
      unavailableScheduledDesc: "Unavailable from {from} to {until}.",
    ...
    people: {
      ...
      bulkVerifySuccess: "Profiles confirmed.",
      bulkBlockSuccess: "Accounts blocked.",
      bulkDeleteSuccess: "Accounts deleted.",
      bulkDeleteConfirmTitle: "Delete selected accounts?",
      bulkDeleteConfirmDesc:
        "These accounts will be permanently deleted. This action is irreversible.",
    },
    blocked: {
  ...
  fr: {
    ...
    search: {
      ...
      guestTitle: "Trouver un invité",
      guestPlaceholder: "Rechercher par nom, région...",
      noGuests: "Aucun invité ne correspond à votre recherche.",
      searchGuestsBarPlaceholder: "Trouvez un invité pour votre table...",
      anonymousGuest: "Un invité",
      guestsInRegion: "invité",
      guestsInRegionPlural: "invités",
      chooseRegionHint: "Choisissez une région pour voir ses invités",
      regionPlaceholder: "Filtrer les régions...",
    ...
    requests: {
      ...
      // Invitation hôte → invité
      inviteDialogTitle: "Inviter à votre table",
      inviteDialogDesc: "Invitez {name} à votre table de Chabbat.",
      sendInvitation: "Envoyer l'invitation",
      toastInvitationSent: "Invitation envoyée.",
      // Libellés de fil selon le sens
      wantsToBeHostedLabel: "Souhaite être reçu(e)",
    ...
    errors: {
      ...
      guestNotFound: "Cet invité est introuvable.",
      cannotRequestSelf:
    ...
    hostProfile: {
      ...
      unavailablePeriodLabel: "Période d'indisponibilité",
      selectPeriod: "Choisir les dates",
      makeUnavailableIndefinitely: "Indisponible jusqu'à nouvel ordre",
      unavailableScheduledDesc: "Indisponibilité prévue du {from} au {until}.",
    ...
    people: {
      ...
      bulkVerify: "Confirmer",
      bulkBlock: "Bloquer tout",
      bulkDelete: "Supprimer tout",
      bulkVerifySuccess: "Profils confirmés.",
      bulkBlockSuccess: "Comptes bloqués.",
      bulkDeleteSuccess: "Comptes supprimés.",
      bulkDeleteConfirmTitle: "Supprimer la sélection ?",
      bulkDeleteConfirmDesc:
        "Ces comptes seront définitivement supprimés. Cette action est irréversible.",
    },
    blocked: {
  ...
  he: {
    ...
    search: {
      ...
      // מצב חיפוש מארח → אורח
      guestTitle: "מצא אורח",
      guestPlaceholder: "חיפוש לפי שם, אזור...",
      noGuests: "לא נמצאו אורחים התואמים לחיפוש שלך.",
      searchGuestsBarPlaceholder: "מצא אורח לשולחן שלך...",
      anonymousGuest: "אורח",
      guestsInRegion: "אורח",
      guestsInRegionPlural: "אורחים",
      chooseRegionHint: "בחר אזור כדי לראות את האורחים בו",
      regionPlaceholder: "סינון אזורים...",
    ...
    requests: {
      ...
      // הזמנה מארח → אורח
      inviteDialogTitle: "הזמנה לשולחן שלך",
      inviteDialogDesc: "הזמן את {name} לשולחן השבת שלך.",
      sendInvitation: "שלח הזמנה",
      toastInvitationSent: "ההזמנה נשלחה.",
      // תוויות לפי כיוון
      wantsToBeHostedLabel: "מעוניין/ת להתארח",
    ...
    hostProfile: {
      ...
      clearReturnDate: "נקה",
      unavailablePeriodLabel: "תקופת אי-זמינות",
      selectPeriod: "בחר תאריכים",
      makeUnavailableIndefinitely: "לא זמין עד להודעה חדשה",
      unavailableScheduledDesc: "לא זמין מ-{from} עד {until}.",
    ...
    people: {
      ...
      bulkBlock: "חסום הכל",
      bulkDelete: "מחק הכל",
      bulkVerifySuccess: "פרופילים אושרו.",
